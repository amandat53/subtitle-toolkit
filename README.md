...
Handles well-formed .srt input and writes .srt or .vtt output. Doesn't yet
read .vtt, .ass, or .sub, and doesn't fix overlaps automatically. See the
source for the full surface — it's under 300 lines.
